...
exports.loginUser = async (req, res, next) => {
    try {
        ...
        // const entreprenuer = await models.checkEntreprenuerRole(req.body.email);
        // const learner = await models.checkLearnerRole(req.body.email);
        // const admin = await models.checkAdminRole(req.body.email);
